...
public class SpecificationWrapper<T, K> implements Specification<K> {
	private Specification<T> specification;
	private IMoEntityConvertor convertor;
	
	public SpecificationWrapper(Specification<T> spec, IMoEntityConvertor<T, K> convertor){
	...
	class MoRoot<X, Y> implements Root<X>{
		private Root<Y> root;
		public MoRoot(Root<Y> root){
			this.root = root;
		}
		@Override
		...
		@Override
		public <Y> Fetch<X, Y> fetch(
				PluralAttribute<? super X, ?, Y> attribute, JoinType jt) {
			// TODO Auto-generated method stub
			return null;
		}
